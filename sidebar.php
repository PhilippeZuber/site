...
<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        if ($_SESSION['role'] == 1) {/*visible for admin only*/
            ...
            <li class="<?php echo $page=='usage_stats' ? 'active' : ''; ?>">
                <a href="usage_stats.php">
    ...
    ?>
        ...
        <ul class="list-unstyled CTAs">
            <li><a href="login.php" class="btn1">Registriere dich kostenlos um deine eigenen Wortlisten zu speichern.</a></li>
        </ul>
    <?php
        }
    ?>
