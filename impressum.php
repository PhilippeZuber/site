                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="page-header">
                                ...
                                <p><b>2.3 </b>Diese Website nutzt die nachfolgenden beschriebenen Technologien und Tools. Sofern Sie deren Nutzung nicht wünschen, nennen wir Ihnen bei dem jeweiligen Tool verschiedene Möglichkeiten und Einstellungen, um deren Nutzung zu verhindern.</p>
                                <p><b>2.4 Google Analytics</b></p>
                                <p><b>2.4.1 </b>Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc, (1600 Amphitheatre Parkway Mountain View, CA 94043, USA; “Google“). Die Nutzung umfasst die Betriebsart “Universal Analytics“. Hierdurch ist es möglich, Daten, Sitzungen und Interaktionen über mehrere Geräte hinweg einer pseudonymen User-ID zuzuordnen und so die Aktivitäten eines Nutzers geräteübergreifend zu analysieren. Google Analytics verwendet sog. Cookies, Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen.</p>
                                <p><b>2.4.3 </b>Sie können die Speicherung der Cookies durch eine entsprechende Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich werden nutzen können. Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie ein Browser Add-On (unter https://tools.google.com/dlpage/gaoptout?hl=de) herunterladen und installieren. Opt-Out-Cookies verhindern die zukünftige Erfassung Ihrer Daten beim Besuch dieser Website. Um die Erfassung durch Universal Analytics über verschiedene Geräte hinweg zu verhindern, müssen Sie das Opt-Out auf allen genutzten Systemen durchführen.</p>
                                <p><b>2.4.4 </b>Die Verwendung von Google Analytics erfolgt auf Grundlage unseres berechtigten Interesses an einer bedarfsgerechten Gestaltung, der statistischen Auswertung sowie der effizienten Bewerbung unserer Webseite. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO.</p>
                                <p><b>2.5 Grundlegende funktionale Cookies</b></p>
                                <p><b>2.5.1 </b>Neben den in Ziff. 2.4 genannten Cookies verwendet diese Website weitere Cookies. Bei Cookies handelt es sich um kleine Textdateien, die lokal im Zwischenspeicher Ihres Browsers gespeichert werden. Nachfolgend aufgezählte Cookies werden von uns nur verwendet, um die Durchführung bzw. Bereitstellung des von Ihnen genutzten Dienstes zu gewährleisten gem. Art. 6 Abs. 1 lit. f DSGVO. Unser berechtigtes Interesse an der Datenverarbeitung liegt dabei darin, die Website-Einstellungen für das von Ihnen verwendete Endgerät zu optimieren und die Benutzeroberflächen anzupassen. Sofern Sie weitere Informationen hinsichtlich der nach Art. 6 Abs. 1 lit. f DSGVO durchzuführenden Interessenabwägung benötigen, kontaktieren Sie uns bitte unter den oben angegebenen Kontaktdaten. Folgende Arten von Cookies, deren Umfang und Funktionsweise im Folgenden erläutert werden, werden auf dieser Website verwendet:</p>
                                <ul>
                                    <li>Transiente Cookies (dazu 2.5.2)</li>
                                    <li>Persistente Cookies (dazu 2.5.3)</li>
                                </ul>
                                <p><b>2.5.2 </b>Transiente Cookies werden automatisiert gelöscht, wenn Sie den Browser schliessen. Dazu zählt insbesondere der Session-Cookie. Dieser speichert eine sogenannte Session-ID, mit welcher sich verschiedene Anfragen Ihres Browsers der gemeinsamen Sitzung zuordnen lassen. Dadurch kann Ihr Rechner wiedererkannt werden, wenn Sie auf unsere Website zurückkehren. Der Session-Cookies wird gelöscht, wenn Sie sich ausloggen oder den Browser schliessen.</p>
                                <p><b>2.5.3 </b>Persistente Cookies werden automatisiert nach einer vorgegebenen Dauer gelöscht, die sich je nach Cookie unterscheiden kann. Sie können die Cookies in den Sicherheitseinstellungen Ihres Browsers jederzeit löschen. Im Fall von wortlab.ch wird ein einziger Cookie persistent gespeichert, der nach spätestens 360 Tagen automatisch gelöscht wird.</p>
                                <p><b>2.5.4 </b>Sie können Ihre Browser-Einstellung entsprechend Ihren Wünschen konfigurieren und z. B. die Annahme von Third-Party-Cookies oder von allen Cookies ablehnen. Wir weisen Sie darauf hin, dass Sie dann eventuell nicht alle Funktionen dieser Website nutzen können.</p>
